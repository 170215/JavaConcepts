...
public class StatusException {
    public static void main(String[] args) throws MaritalStatus {
        ...
        switch(s){
            case "s":
            case "S":
                System.out.println("Your status is single");
                break;
            case "M":
            case "m":
                System.out.println("Your status is Married");
                break;
            case "D":
            case "d":
                System.out.println("Your status is Divorcee");
                break;
            default:
...
class MaritalStatus extends Exception{
